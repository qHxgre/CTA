...
class future_grid_inf_v103(CtaTemplate):
    """期货网格策略"""
    vtSymbol = ''
    exchange = ''
    className = 'future_grid_inf_v103'
    author = 'hxgre'
    ...
    def __init__(self,ctaEngine=None,setting={}):
        ...
        self.position_filename = 'posSR401.h5'
        self.strategy_filename = 'paraSR401.csv'
    ...
    def update_qty(self):
        """下单前根据账户资金计算下单手数"""
        # 以 4,000,000 - 10 为标准计算现有的下单手数
        init_money = 4000000
        init_qty = 10
        account_balance = self.get_investor_account(self.account_id).balance
        self.strategy_parameters.update_account_balance(account_balance)
        new_qty = int((account_balance / init_money) * init_qty)
