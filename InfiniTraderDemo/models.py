...
class Base(object):
    def __str__(self) -> str:
        ...
        return json.dumps(model_dict, ensure_ascii=False)
...
class Position_p(object):
    ...
    def __init__(self, data: dict = {}) -> None:
        self._exchange_id = data.get("ExchangeID", "")
    ...
    @property
    def position_cost(self) -> Union[float, int]:
        """总持仓成本"""
        return self._position_cost

    @property
    def yd_position_cost(self) -> Union[float, int]:
        """
        初始昨日持仓成本
    ...
    @property
    def close_profit(self) -> Union[float, int]:
        """平仓盈亏"""
        return self._close_profit

    @property
    def position_profit(self) -> Union[float, int]:
        """持仓盈亏"""
        return self._position_profit

    @property
    def open_avg_price(self) -> Union[float, int]:
        """开仓均价"""
        return self._open_avg_price

    @property
    def position_avg_price(self) -> Union[float, int]:
        """持仓均价"""
